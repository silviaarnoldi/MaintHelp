...
VALUES ('DOCUMENTO', 'Manutenzione', 'preventiva', '$data', '$oretot', '$descrizione', '$id_manutentore', '$id_macchinario')";
...
if ($connessione->query($sql) === TRUE) {
    ...
    if ($connessione->query($sql) === TRUE) {
        ...
        echo "<center>";
        echo "<h1>Manutenzione preventiva eseguita con successo</h1>";
        echo "<br>";
