...
INSERT INTO MACCHINARIO (NOME, STATO, SCHEMA_ELECT,SCHEMA_MEC,PROSSIMA_MANUTENZIONE,ULTIMA_MANUTENZIONE,CHIAMATA_MANUTENTORE) VALUES ('Macchinario1', 1, 'schema_elettrico', 'schema_mecanico', '2024-01-01', '2023-12-01', 0);
INSERT INTO MACCHINARIO (NOME, STATO, SCHEMA_ELECT,SCHEMA_MEC,PROSSIMA_MANUTENZIONE,ULTIMA_MANUTENZIONE,CHIAMATA_MANUTENTORE) VALUES ('Macchinario2', 1, 'schema_elettrico', 'schema_mecanico', '2024-01-01', '2023-12-01', 0);
